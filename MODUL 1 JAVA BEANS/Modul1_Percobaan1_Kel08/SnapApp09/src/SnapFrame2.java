 ...
 * @author Prawito Ardi
 */
public class SnapFrame2 extends javax.swing.JFrame {

    /**
     * Creates new form SnapFrame2
     */
    public SnapFrame2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SnapFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SnapFrame2().setVisible(true);
            }
        });
    }
