<%-- 
    Document   : register
    Created on : Nov 9, 2019, 12:53:46 PM
    Author     : Prawito Ardi
--%>
        ...
        <div class="row content" style="margin-top:70px;">
          <div class="col-md-12">
            <div class="col-md-4 col-md-offset-4 daftar">
                <h1 style="text-align:center; margin-top: 10px; font-size: 20px; font-family: Google Sans;"><b>Registrasi</b></h1>
                <p style="text-align:center; margin-top: 8px; font-size: 12px; font-family: Google Sans;">Sudah Punya Akun ? <a style="color: green" href="./login.jsp"/><b>Sign In</b></a><br></p>
              <form method="POST" action="./RegisterServlet">
                ...
                <div class="form-group">
                  ...
                  <input style="font-family: Google Sans;" type="password" class="form-control" placeholder="Password" name="password" value="" required />
                    ...
                    <center>
                  <input style="text-align:center; font-family: Google Sans; width: 100%; margin-top: 20px;" type="submit" name="register" value="Register" class="btn btn-md btn-success" />
                    </center>
              </form>
            </div>
          </div>
