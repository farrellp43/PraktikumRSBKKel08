...
public class LoginSevlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if("Keluar".equals(request.getParameter("keluar"))){
            ...
            request.setAttribute("nimEr", "21120116120019");
            request.setAttribute("namaEr", "Prawito");
        }
    ...
    private LoginSessionLocal lookupLoginSessionLocal() {
        try {
            ...
            return (LoginSessionLocal) c.lookup("java:global/Modul2_Kelompok09/Modul2_Kelompok09-ejb/LoginSession!Kelompok09.LoginSessionLocal");
